        ...
        <section class="section-container hero">
            <div class="owl-carousel hero__carousel owl-theme">
                ...
                <div class="hero__item">
                    ...
                    <img class="hero__img" src="{{ asset('storage/'.$banner->image)}}" alt ="image" loading="lazy" style="width: 100%; height: auto; max-width: 100vw; max-height: 50vh;">
                    @else
                    <img class="hero__img" src="{{ asset($banner->image)}}" alt ="image" loading="lazy" style="width: 100%; height: auto; max-width: 100vw; max-height: 50vh;">
                    @endif
                </div>
                @endforeach
            </div>

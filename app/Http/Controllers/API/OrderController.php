...
class OrderController extends Controller
{
    ...
    function store(Request $request)
    {
        ...
        $cart->destroy();
        return response()->json(['data'=>$order_id,'message'=>'تم اتمام الطلب بنجاح']);
    }
    function GetOrderData()
    {
        $cart_id = Cart::where('user_id', Auth::guard('sanctum')->user()->id)->select('id', 'total')->get();
    ...
    {
        $orders = Order::where('user_id', Auth::guard('sanctum')->user()->id)->get();
    ...
    public function Checkout()
    {
        ...
        return response()->json(['books'=>$items,'total_after_discount'=>$total_after_discount,'total'=>$total]);
    }
    ...
    function OrderDetails($order_id)
    {
        ...
        return response()->json(['books'=>$books,'invoice'=>$invoice_data]);
    }
    function vieworders()
    {
